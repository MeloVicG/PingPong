...
# initalize few things we need
pygame.init()

# declare 2 variables in same line
...
def handle_collision(ball, left_paddle, right_paddle):
    ...
    if ball.x_vel < 0:
        ...
        if ball.y >= left_paddle.y and ball.y <= left_paddle.y + left_paddle.height:
            # direction ball moves on collision
...
# whenever in a pygame need a main loop
#     handles collision, events, etc
    while run:
        clock.tick(FPS)
